...
% --- TÍTULO Y AUTORES ---
\title{Título Formal de la Publicación Científica o Artículo de Investigación}

\author{Juan~David~Wilches~Gutierrez,
        y~Nombre~Segundo~Autor%
\thanks{J. D. Wilches Gutierrez trabaja en el área de Ciencia de Datos e Inteligencia Artificial (contacto: usuario@dominio.com).}%
\thanks{Manuscrito recibido el 5 de agosto de 2026; revisado el 10 de agosto de 2026.}}

% Encabezado Superior
\markboth{Revista de Inteligencia Artificial y Ciencia de Datos,~Vol.~14, No.~8,~Agosto~2026}%
{Wilches \MakeLowercase{\textit{et al.}}: Título Corto del Artículo}
...
\begin{IEEEkeywords}
Aprendizaje Automático, Modelos Predictivos, LaTeX, Publicación Científica, Procesamiento de Datos.
\end{IEEEkeywords}
